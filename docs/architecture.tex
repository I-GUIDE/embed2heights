...
\begin{tikzpicture}[
  ...
  \node[pix] (aenc) at (3.6,3.0){UNet++$_\alpha$};
  \node[pix] (tenc) at (3.6,1.5){calib $\to$ UNet++$_t$};
  ...
  \node[op,fill=cOut!8,draw=cOut,text width=24cm,align=center,inner sep=7pt,
     ...
     \textbf{Stage 1} (coupled, 80 ep) trains everything $\Rightarrow$ a \emph{shared init}.\quad

...
\begin{frame}{Architecture at a glance}
  ...
  \vspace{0.4em}
  {\footnotesize
   \textcolor{cAlpha}{$\blacksquare$ 1 dense pixel}\quad
   \textcolor{cToken}{$\blacksquare$ 2 coarse token}\quad
   \textcolor{cOut}{$\blacksquare$ 3 fusion}\quad
   \textcolor{cHead}{$\blacksquare$ 4 split head}\quad
   \textcolor{cGray}{dashed = two-stage training}}
\end{frame}

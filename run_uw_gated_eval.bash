#!/bin/bash
#SBATCH --job-name=emb2h_uw_gated_eval
...
# Predict + evaluate the three uw_gated arms on val split.
# Champion N: 0.4644.  Promotion bar: 0.4704.
...
for exp in uw_gated_F uw_gated_U uw_gated_FU; do
    echo "============================================"
    echo "[PREDICT] $exp"
    echo "============================================"
    python predict.py \
...
echo "============================================"
python evaluate.py \
    --only uw_gated_F uw_gated_U uw_gated_FU \
    --val-only \

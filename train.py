...
def build_active_model(args, n_channels):
    return build_model(
        ...
        unetpp_deep_supervision=bool(getattr(args, "unetpp_deep_supervision", False)),
...
def build_loss(args, device):
    criterion = ImprovedCompositeLoss(
        ...
        unetpp_ds_weight=getattr(args, "unetpp_ds_weight", 0.0),
        unetpp_ds_height_weight=getattr(args, "unetpp_ds_height_weight", 0.0),

#!/bin/bash
#SBATCH --job-name=emb2h_E60h
#SBATCH --output=slurm_logs/%x_%A_%a.out
#SBATCH --error=slurm_logs/%x_%A_%a.err
#SBATCH --time=08:00:00          # HRNet 60ep, train to convergence
#SBATCH --mem=64G
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=8
#SBATCH --partition=gpu          # prefer H100; fall back to gpu_a100 if it queues
#SBATCH --gres=gpu:1
...
EXP="arch_hrnet_carafe_softbin_pinball_boundary_60ep_fold${FOLD}"

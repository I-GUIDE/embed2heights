...
# decoder upsampler (identical to champion (control)). Everything else is byte-identical to
...
#   This run : uw_gated_F_bilinear_fold0 (only adds --upsample-kind bilinear)
#
...
EXP="uw_gated_F_bilinear_fold${FOLD}"
SPLIT="${SPLITS_ROOT}/fold_${FOLD}/split.json"

echo "========================================"
echo "Bilinear baseline (same branch) | fold=$FOLD  exp=$EXP"
